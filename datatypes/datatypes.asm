...
section .data                        ;all the initialized data is put in data section
	...
	var1: db 0xAA
	;var2: db 0xAAA1             gives error data out of bounds because it is define bytes, and only a byte can be stored, but we are trying to store 2 bytes
	;var3: db 0xAAA132           same here
	var2: db "0xAAA1"            ;for this it is taking 0 x a a a 1 3 2   as string characters separately, and storing ascii code in sequence
	var3: db 0xA1, 0x32, 0x4C
	var4: dw 0xA1, 0x32, 0x4C
	var5: dw 0xA1
	var6: dw 0xA132
	var7: dd 0xA1
	var8: dd 0xA1, 0x32, 0x4C
	var9: dd 0xAAA1324C
	var10: Times 6 db 0x4A
